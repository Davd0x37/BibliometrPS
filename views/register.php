...
<form action="register.php" method="post" class="autoryzacja">
    <div class="autoryzacja__box fieldset__container">
...
if (
    ...
    if ($user) {
        ...
        $cr = User::create($_POST['name'], $_POST['haselko'], $_POST['mail'], $_POST['afiliacja']);
        if ($cr) {
